              ...
              <FormControl>
                ...
                >
                  ...
                  <FormItem className='flex items-center'>
                    ...
                    <FormLabel className='font-normal'>仅私信和提及</FormLabel>
                  </FormItem>
                  <FormItem className='flex items-center'>
                    <FormControl>
              ...
              render={({ field }) => (
                <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
                  <div className='space-y-0.5'>
                    <FormLabel className='text-base'>账户动态通知</FormLabel>
              ...
              render={({ field }) => (
                <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
                  <div className='space-y-0.5'>
                    ...
                    <FormDescription>接收新产品、功能等营销信息。</FormDescription>
                  </div>
                  <FormControl>
                    <Switch checked={field.value} onCheckedChange={field.onChange} />
                  </FormControl>
              ...
              render={({ field }) => (
                <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
                  <div className='space-y-0.5'>
                    ...
                    <FormDescription>接收好友请求、关注等社交通知。</FormDescription>
                  </div>
                  <FormControl>
                    <Switch checked={field.value} onCheckedChange={field.onChange} />
                  </FormControl>
              ...
              render={({ field }) => (
                <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
                  <div className='space-y-0.5'>
                    ...
                    <FormDescription>接收账户安全相关的重要通知。</FormDescription>
                  </div>
                  <FormControl>
                    <Switch
                      checked={field.value}
          ...
          render={({ field }) => (
            <FormItem className='relative flex flex-row items-start'>
              ...
              <div className='space-y-1 leading-none'>
                <FormLabel>移动设备使用不同的设置</FormLabel>
                <FormDescription>
                  您可以在
